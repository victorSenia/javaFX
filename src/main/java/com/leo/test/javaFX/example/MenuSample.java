...
public class MenuSample extends Application {
    ...
    private static CheckMenuItem createMenuItem(String title, final Node node) {
        ...
        cmi.selectedProperty().addListener((ov, old_val, new_val) -> {
    ...
    public void start(Stage stage) {
        ...
        clear.setOnAction(t -> vbox.setVisible(false));
        ...
        for (Entry effect : effects) {
            RadioMenuItem itemEffect = new RadioMenuItem(effect.getKey().toString());
    ...
    private class PageData {
        ...
        public PageData(String name, String description, String binNames) {
            ...
            image = new Image("menusample/" + name + ".jpg");
        }
    }
}